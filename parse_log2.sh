...
# Generating
echo '#Iters Seconds TestAccuracy TestLoss'> $POS/$LOG.test
paste aux0.txt aux4.txt aux1.txt aux2.txt | column -t >> $POS/$LOG.test
...
# Generating
echo '#Iters Seconds TrainingLoss LearningRate'> $POS/$LOG.train
paste aux0.txt aux3.txt aux1.txt aux2.txt | column -t >> $POS/$LOG.train
